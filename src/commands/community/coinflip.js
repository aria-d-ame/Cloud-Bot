  ...
  data: new SlashCommandBuilder()
    ...
    if (userMoney.Money < betAmount) {
      return interaction.reply(`You don't have enough Pix-Stars to bet! You only have ${userMoney.Money}!`);
		...
		const choice = [
      `🪙 | ${interaction.user} spends <:xPix_Stars:1275118528844009563>${betAmount} to flip a coin... it's **HEADS**!`,
      `🪙 | ${interaction.user} spends <:xPix_Stars:1275118528844009563>${betAmount} to flip a coin... it's **TAILS**!`,
    ];
