...
module.exports = {
    ...
    const baseAmount = getRandomInt(minGive, maxGive);
		...
		if (timeSinceLastDaily < COOLDOWN_DAILY) {
			...
			return interaction.reply({ content: `You can use this command again in <t:${Math.floor(expirationTime / 1000)}:R>!`, ephemeral: true });
		}
    ...
    if (hasExtraCashRole) {
        const extraCash = 50; // Define how much extra money to give
        ...
        .setDescription(`**«═══✧ ✦ ✧ ✦ ✧═══»**\n You have claimed your daily for <:xPix_Stars:1275118528844009563>${baseAmount}, and you have recieved an additional <:xPix_Stars:1275118528844009563>50 for boosting! Come back in 24 hours!`)
